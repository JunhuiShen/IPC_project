...
double per_vertex_safe_step(const BroadPhase& broad_phase, std::vector<Vec3>& x, int vi, const Vec3& raw_proposed_position, double safety = 0.9, bool clip_ccd = true, bool use_ticcd = true, bool use_ogc = false);
