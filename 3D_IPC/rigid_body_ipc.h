...
struct RigidEnergyDerivatives {
    ...
    Mat33 translation_translation_hessian;
    Mat33 translation_orientation_hessian;
    Mat33 orientation_orientation_hessian;

    RigidEnergyDerivatives() : translation_gradient(Vec3::Zero()), orientation_gradient(Vec3::Zero()), translation_translation_hessian(Mat33::Zero()), translation_orientation_hessian(Mat33::Zero()), orientation_orientation_hessian(Mat33::Zero()) {}
};
