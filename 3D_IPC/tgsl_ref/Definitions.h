...
using Vector5T = std::array<T, 5>;
using Vector6T = std::array<T, 6>;
using Vector2I = std::array<nm, 2>;
using Vector3I = std::array<nm, 3>;
using Vector4I = std::array<nm, 4>;
using Vector5I = std::array<nm, 5>;
using Vector6I = std::array<nm, 6>;
...
using Vector6d = Eigen::Matrix<T, 6, 1>;
using Matrix6d = Eigen::Matrix<T, 6, 6>;
using Vector7d = Eigen::Matrix<T, 7, 1>;
using Matrix7d = Eigen::Matrix<T, 7, 7>;
...
using TVP4 = std::vector<Vector4T>;
...
constexpr nm INVALID_INDEX = std::numeric_limits<nm>::max();
