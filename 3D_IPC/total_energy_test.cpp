...
Vec3 local_gradient_fd(int vi, const RefMesh& ref_mesh, const VertexAdjacencyMap& adj, const std::vector<Pin>& pins, const SimParams& params, const std::vector<Vec3>& x, const std::vector<Vec3>& xhat, const std::vector<NodeTrianglePair>& nt_pairs, const std::vector<SegmentSegmentPair>& ss_pairs, double eps){
    Vec3 gfd = Vec3::Zero();
    for (int d = 0; d < 3; ++d) {
        auto xp = x, xm = x;
...
Mat33 local_hessian_fd(int vi, const RefMesh& ref_mesh, const VertexAdjacencyMap& adj, const std::vector<Pin>& pins, const SimParams& params, const std::vector<Vec3>& x, const std::vector<Vec3>& xhat, const std::vector<NodeTrianglePair>& nt_pairs, const std::vector<SegmentSegmentPair>& ss_pairs, double eps){
    Mat33 H = Mat33::Zero();
    for (int d = 0; d < 3; ++d) {
        auto xp = x, xm = x;
        xp[vi](d) += eps; xm[vi](d) -= eps;
...
void slope2_check(int vi, const RefMesh& ref_mesh, const VertexAdjacencyMap& adj, const std::vector<Pin>& pins, const SimParams& params, const std::vector<Vec3>& x, const std::vector<Vec3>& xhat, const std::vector<NodeTrianglePair>& nt_pairs, const std::vector<SegmentSegmentPair>& ss_pairs){
